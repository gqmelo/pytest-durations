# -*- coding: utf-8 -*-
#
# pytest-durations documentation build configuration file, created by
...
project = u'pytest-durations'
copyright = u'2015, Guilherme Quentel Melo'
author = u'Guilherme Quentel Melo'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-durations Documentation',
     [author], 1)
]
